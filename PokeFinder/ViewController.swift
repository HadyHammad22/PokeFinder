...
//  PokeFinder
//
//  Created by Hady Hammad on 11/18/19.
...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate{
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        ...
        if let anno = view.annotation as? PokeAnnotation{
            ...
            let regionSpan = MKCoordinateRegion.init(center: anno.coordinate, latitudinalMeters: regionDistance, longitudinalMeters: regionDistance)
    ...
    @IBAction func spotRandomPokemon(_ sender: Any) {
        ...
        let rand = arc4random_uniform(31) + 1
        self.createSighting(forLocation: loc, withPokemon: Int(rand))
    }
}
